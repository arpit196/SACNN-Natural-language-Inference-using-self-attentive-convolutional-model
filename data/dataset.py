...
class MNLIDataset(DatasetExperiment):
    ...
    def train_set_pairs(self):
        return self.train[[sentence1.name, sentence2.name]].as_matrix()

    def train_labels(self):
        return self.train[labels.name].as_matrix()

    def dev_set(self):
        return self.dev

    def dev_set_pairs(self):
        return self.dev[[sentence1.name, ColumnType.sentence2.name]].as_matrix()
...
DATASETS = {
    ...
    DatasetType.MNLI.name: MNLIDataset
}
