...
def stacked_multihead_attention(x, num_blocks, num_heads, use_residual, is_training, reuse=True):
...
def multihead_attention(queries, keys, values, use_residual, is_training, num_units=None, num_heads=8, reuse=tf.AUTO_REUSE):
